<?php
/*
 * lib/CONFIG.server.sample.php
 * LHS Math Club Website
 *
 * !!!SAMPLE SAMPLE SAMPLE SAMPLE SAMPLE!!!
 *
 * A sample configuration file for CONFIG.server.php
 * (this was public CONFIG.php until the 2/22/2016 mail security breach)
 * The real one is not Git tracked for security reasons, and can be found in the Webmasters' Dropbox.
 *
 */
