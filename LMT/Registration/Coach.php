...
function process_form() {
	...
	lmt_query('INSERT INTO schools (name, coach_email, access_code) VALUES ("'
		. mysqli_real_escape_string($GLOBALS['LMT_DB'],$school_name)
		. '", "' . mysqli_real_escape_string($GLOBALS['LMT_DB'],$email)
		. '", "' . mysqli_real_escape_string($GLOBALS['LMT_DB'],$access_code)
		. '")');
	
	// Get user id (which is automatically generated by MySQL)
	$row = lmt_query('SELECT school_id FROM schools WHERE coach_email="' . mysqli_real_escape_string($GLOBALS['LMT_DB'],$email) . '"', true);
	$id = $row['school_id'];
