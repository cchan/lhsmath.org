...
function process_form() {
	...
	lmt_query('INSERT INTO individuals (name, email, grade, team) VALUES ("'
		...
		. '", "' . mysqli_real_escape_string($GLOBALS['LMT_DB'],$grade)
		. '", "-1")');
	
	// Get user id (which is automatically generated by MySQL)
	$row = lmt_query('SELECT id FROM individuals WHERE email="' . mysqli_real_escape_string($GLOBALS['LMT_DB'],$email) . '"', true);
	$id = $row['id'];
