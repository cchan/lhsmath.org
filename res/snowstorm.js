...
var snowStorm = (function(window, document) {
  ...
  this.snowCharacter = '&pi;';  // &bull; = bullet, &middot; is square on some systems etc.
  ...
  this.SnowFlake = function(type,x,y) {
    ...
    this.o.style.fontFamily = 'Georgia,arial,verdana';
    this.o.style.cursor = 'default';
    this.o.style.overflow = 'hidden';
    this.o.style.fontWeight = 'normal';
    this.o.style.zIndex = storm.zIndex;
	
	this.o.style.overflow = "visible";
	this.PI = 3.141592653589;
	this.tilt = 0;
	this.tiltPhaseOffset = Math.random() * 2 * s.PI;
	//this.tiltPeriod = Math.random() * 3 + 1;
	this.tilt = Math.sin(s.tiltPhaseOffset);// + 2 * s.PI * (Date.now() / 1000 | 0) / s.tiltPeriod); // +/- 1 radian. //asdf | 0 is apparently floor(asdf)
	this.o.style.webkitTransform = 'rotate('+s.tilt+'rad)';
	this.o.style.mozTransform    = 'rotate('+s.tilt+'rad)';
	this.o.style.msTransform     = 'rotate('+s.tilt+'rad)';
	this.o.style.oTransform      = 'rotate('+s.tilt+'rad)';
	this.o.style.transform       = 'rotate('+s.tilt+'rad)';
